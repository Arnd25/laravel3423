    ...
    <div class="flex flex-col w-full gap-5">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-1.5 ">
                <p class="bg-gray-200 text-black py-2 px-3 text-sm font-medium rounded-lg">Full-time</p>
                <p class="bg-gray-200 text-black py-2 px-3 text-sm font-medium rounded-lg">Full-time</p>
            </div>
        </div>
    </div>
    <div class="border-t border-t-gray-300 flex justify-between items-center pt-5">
        <div class="flex flex-col font-normal">
            <p class="text-lg text-black font-medium">$120-220k</p>
            <p class="text-gray-400 text-sm">Mountain View, CA</p>
        </div>
        <button class="text-white bg-black rounded-lg h-fit py-2.5 px-4">Apply now</button>
    </div>
</li>
