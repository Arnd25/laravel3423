    ...
    <x-ui.container class="flex flex-col items-center">
        ...
        <form class="flex flex-col w-xl bg-sky-200 p-4 rounded-lg shadow-xl gap-2 mt-20"
            ...
            <div class="flex flex-col gap-1">
                ...
                <input class="bg-white rounded-lg p-2" name="title" type="text" value="{{old('title', $product->title)}}" placeholder="Введите название услуги">
            </div>
            <div class="flex flex-col gap-1">
                <div class="flex justify-between">
                ...
                <textarea rows="5" class="bg-white rounded-lg p-2" name="description" type="text" placeholder="Введите описание услуги">{{old('description', $product->description)}}</textarea>
            </div>
            <div class="flex flex-col gap-1">
                <div class="flex justify-between">
                    <label for="title">Описание услуги*</label>
                ...
                <textarea rows="15" class="bg-white rounded-lg p-2" name="content" type="text" placeholder="Введите описание услуги">{{old('description', $product->content)}}</textarea>
            </div>
            <div class="flex flex-col gap-1">
                <div class="flex justify-between">
                ...
                <input class="bg-white rounded-lg p-2" name="tags" type="text" value="{{old('tags', implode(',', $product->tags))}}" placeholder="Введите название услуги">
            </div>
            <div class="flex flex-col gap-1">
                <div class="flex justify-between">
                ...
                <div class="w-full flex">
                    <img width="50" height="50" src="{{asset('storage/'. $product->main_image)}}" alt="Изображение усулуги"/>
