...
<head>
    ...
    <title>Услуга {{$product->title}}</title>
</head>
<body>
<x-header/>
<main>
            ...
            <div class="flow-root border-b-2 border-b-gray-300 pb-4">
                ...
                <div class="flex gap-2">
                    @foreach($product->tags as $tag)
                        <p class="bg-blue-500 rounded-lg py-1 px-4 text-white font-lg">aa</p>
                    @endforeach
                </div>

            </div>
            <p class="mt-5 text-lg whitespace-pre-line wrap-break-word">{{$product->content}}</p>
